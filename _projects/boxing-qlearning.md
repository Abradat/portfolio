...
<div class="text-center">
    <figure class="figure">
        <img src="/assets/img/portfolio/boxing-qlearning/arch.png" class="figure-img img-fluid rounded" alt="Architecture of the Network" style="width: 80%; height: 80%">
...
| Technology | Usage |
|------------------|--------|
| <img src="/assets/img/portfolio/technologies/python.png" width="60" height="60"> | **Pytyhon** is used for implementing the application|
| <img src="/assets/img/portfolio/technologies/tensorflow.png" width="60" height="60"> | **Tensorflow** is the framework for implementing the Q-Learning and DQN|